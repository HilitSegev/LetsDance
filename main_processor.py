...
def process_video(video_path, bg_img_path, emoji_face, color_pallette):
    ...
    # set color to DEFAULT_COLOR if no color is given
    if color_pallette is None:
        color_pallette = DEFAULT_COLOR
    ...
    generated_images_list = skeleton_creator.generate_images(fixed_pose_df,
                                                             mode='sticklight',
